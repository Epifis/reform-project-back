...
public class Usuario implements UserDetails {
    ...
    public Usuario(Long id, String nombre, String email, String contrasena, String telefono, String rol, boolean enabled, String confirmationToken, LocalDateTime confirmationTokenExpiry, String resetPasswordToken, LocalDateTime resetPasswordExpiry) {
        this.id = id;
        this.nombre = nombre;
        this.email = email;
